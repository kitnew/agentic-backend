...
from ...models.tenant_telephony_update import TenantTelephonyUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/admin/v1/tenants/{tenant_id}/telephony".format(
