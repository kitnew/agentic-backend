...
from ...models.update_prompt_set_draft_request import UpdatePromptSetDraftRequest
...
def _get_kwargs(
    ...
    revision_id: UUID,
    *,
    body: UpdatePromptSetDraftRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/admin/v1/tenants/{tenant_id}/prompt-set/drafts/{revision_id}".format(
