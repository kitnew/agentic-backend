...
from ...models.tenant_knowledge_authoring import TenantKnowledgeAuthoring
...
def _get_kwargs(
    tenant_id: UUID,
    *,
    body: TenantKnowledgeAuthoring,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/v1/tenants/{tenant_id}/authoring/knowledge/plan".format(
