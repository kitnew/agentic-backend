...
from ...models.tenant_runtime_authoring import TenantRuntimeAuthoring
...
def _get_kwargs(
    tenant_id: UUID,
    *,
    body: TenantRuntimeAuthoring,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/v1/tenants/{tenant_id}/authoring/runtime/plan".format(
