...
from ...models.tenant_post_call_authoring import TenantPostCallAuthoring
...
def _get_kwargs(
    tenant_id: UUID,
    *,
    body: TenantPostCallAuthoring,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/v1/tenants/{tenant_id}/authoring/post-call/plan".format(
