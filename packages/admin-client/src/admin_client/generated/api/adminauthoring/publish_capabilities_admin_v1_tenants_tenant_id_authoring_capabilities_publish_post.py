...
from ...models.component_publish_request import ComponentPublishRequest
...
def _get_kwargs(
    tenant_id: UUID,
    *,
    body: ComponentPublishRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/v1/tenants/{tenant_id}/authoring/capabilities/publish".format(
