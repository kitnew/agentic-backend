...
from ...models.set_integration_secret_request import SetIntegrationSecretRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/v1/tenants/{tenant_id}/integration-connections/{connection_id}/secrets/rotate".format(
