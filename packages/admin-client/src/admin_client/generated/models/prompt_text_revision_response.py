...
T = TypeVar("T", bound="PromptTextRevisionResponse")


@_attrs_define
class PromptTextRevisionResponse:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        prompt_text_revision_response = cls(
            created_at=created_at,
            id=id,
            published_at=published_at,
            revision_number=revision_number,
        ...
        prompt_text_revision_response.additional_properties = d
        return prompt_text_revision_response
