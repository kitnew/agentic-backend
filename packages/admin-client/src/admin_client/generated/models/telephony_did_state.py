...
T = TypeVar("T", bound="TelephonyDidState")


@_attrs_define
class TelephonyDidState:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        telephony_did_state = cls(
            phone_number=phone_number,
        )

        telephony_did_state.additional_properties = d
        return telephony_did_state
