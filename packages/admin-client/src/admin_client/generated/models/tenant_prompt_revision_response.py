...
T = TypeVar("T", bound="TenantPromptRevisionResponse")


@_attrs_define
class TenantPromptRevisionResponse:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        tenant_prompt_revision_response = cls(
            created_at=created_at,
            id=id,
            prompt_id=prompt_id,
            published_at=published_at,
        ...
        tenant_prompt_revision_response.additional_properties = d
        return tenant_prompt_revision_response
