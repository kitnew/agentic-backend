...
T = TypeVar("T", bound="TenantConfigV4Capabilities")


@_attrs_define
class TenantConfigV4Capabilities:
    """ """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        tenant_config_v4_capabilities = cls()
        ...
        tenant_config_v4_capabilities.additional_properties = additional_properties
        return tenant_config_v4_capabilities
