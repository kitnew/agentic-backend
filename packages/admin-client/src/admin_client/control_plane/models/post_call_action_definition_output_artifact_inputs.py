...
T = TypeVar("T", bound="PostCallActionDefinitionOutputArtifactInputs")


@_attrs_define
class PostCallActionDefinitionOutputArtifactInputs:
    """ """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        post_call_action_definition_output_artifact_inputs = cls()
        ...
        post_call_action_definition_output_artifact_inputs.additional_properties = (
            additional_properties
        )
        return post_call_action_definition_output_artifact_inputs
