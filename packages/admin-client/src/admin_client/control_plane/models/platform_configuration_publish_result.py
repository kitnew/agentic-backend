...
T = TypeVar("T", bound="PlatformConfigurationPublishResult")
...
class PlatformConfigurationPublishResult:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        platform_configuration_publish_result = cls(
            configuration=configuration,
            published_components=published_components,
            unchanged_components=unchanged_components,
        )

        platform_configuration_publish_result.additional_properties = d
        return platform_configuration_publish_result
