...
if TYPE_CHECKING:
    ...
    from ..models.runtime_action_definition_input_agent_input_schema import (
        RuntimeActionDefinitionInputAgentInputSchema,
    )
    from ..models.runtime_action_definition_input_announcement_type_1 import (
        RuntimeActionDefinitionInputAnnouncementType1,
    )
    from ..models.runtime_action_definition_input_bindings import (
        RuntimeActionDefinitionInputBindings,
    )
    from ..models.runtime_action_definition_input_result_schema_type_0 import (
        RuntimeActionDefinitionInputResultSchemaType0,
    )
    from ..models.runtime_business_policy import RuntimeBusinessPolicy


T = TypeVar("T", bound="RuntimeActionDefinitionInput")


@_attrs_define
class RuntimeActionDefinitionInput:
    """
    Attributes:
        agent_input_schema (RuntimeActionDefinitionInputAgentInputSchema):
        announcement (RuntimeActionDefinitionInputAnnouncementType1 | str):
        description (str):
        execution (HttpSemanticExecutionInput):
        phase (Literal['runtime']):
        bindings (RuntimeActionDefinitionInputBindings | Unset):
        business_policy (RuntimeBusinessPolicy | Unset):
        input_constraints (list[DateRangeConstraint] | Unset):
        result_schema (None | RuntimeActionDefinitionInputResultSchemaType0 | Unset):
    """
    ...
    execution: HttpSemanticExecutionInput
    phase: Literal["runtime"]
    bindings: RuntimeActionDefinitionInputBindings | Unset = UNSET
    business_policy: RuntimeBusinessPolicy | Unset = UNSET
    input_constraints: list[DateRangeConstraint] | Unset = UNSET
    result_schema: None | RuntimeActionDefinitionInputResultSchemaType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.announcement, RuntimeActionDefinitionInputAnnouncementType1):
        ...
        if isinstance(self.result_schema, Unset):
            ...
            self.result_schema, RuntimeActionDefinitionInputResultSchemaType0
        ):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        agent_input_schema = RuntimeActionDefinitionInputAgentInputSchema.from_dict(
            d.pop("agent_input_schema")
        )

        def _parse_announcement(
            data: object,
        ) -> RuntimeActionDefinitionInputAnnouncementType1 | str:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                announcement_type_1 = (
                    RuntimeActionDefinitionInputAnnouncementType1.from_dict(data)
                )

                return announcement_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(RuntimeActionDefinitionInputAnnouncementType1 | str, data)
        ...
        if isinstance(_bindings, Unset):
            ...
            bindings = RuntimeActionDefinitionInputBindings.from_dict(_bindings)
        ...
        def _parse_result_schema(
            data: object,
        ) -> None | RuntimeActionDefinitionInputResultSchemaType0 | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                result_schema_type_0 = (
                    RuntimeActionDefinitionInputResultSchemaType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | RuntimeActionDefinitionInputResultSchemaType0 | Unset, data
            )

        result_schema = _parse_result_schema(d.pop("result_schema", UNSET))

        runtime_action_definition_input = cls(
            agent_input_schema=agent_input_schema,
            announcement=announcement,
            description=description,
            execution=execution,
        ...
        return runtime_action_definition_input
