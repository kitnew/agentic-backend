...
from ...models.platform_configuration_apply_result import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/management/v1/platform/configuration",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PlatformConfigurationApplyResult.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | PlatformConfigurationApplyResult
    """
