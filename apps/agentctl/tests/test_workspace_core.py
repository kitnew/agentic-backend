...
from agentctl.backend.generated import GeneratedRemoteAuthoringAdapter
from agentctl.commands.errors import CommandError
from agentctl.workspace.codecs import load
...
from agentctl.workspace.registry import descriptors
...
def test_global_push_required_missing_blocks_all_saves(
    ...
    monkeypatch.setattr("agentctl.application.workspace.selected", selected)
